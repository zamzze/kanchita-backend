...
CREATE INDEX IF NOT EXISTS idx_streams_content
  ON streams (content_type, content_id) WHERE is_active = TRUE;
...
CREATE INDEX IF NOT EXISTS idx_content_genres
  ON content_genres (content_type, content_id);
CREATE INDEX IF NOT EXISTS idx_subscriptions_user
  ON subscriptions (user_id) WHERE status = 'active';
CREATE INDEX IF NOT EXISTS idx_scraper_log_tmdb
  ON scraper_log (tmdb_id, executed_at DESC);
