    ...
    return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, page.evaluate(function () {
                                var _a, _b;
                                ;
                                (_b = (_a = window).removeMouseHelper) === null || _b === void 0 ? void 0 : _b.call(_a);
                            })];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, page.removeScriptToEvaluateOnNewDocument(evaluateOnNewDocumentId)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, page.evaluateOnNewDocument(function () {
                        var attachListener = function () {
                            ...
                            var onMouseMove = function (event) {
                                box.style.left = "".concat(event.pageX, "px");
                                box.style.top = "".concat(event.pageY, "px");
                                box.classList.remove('p-mouse-pointer-hide');
                                updateButtons(event.buttons);
                            };
                            var onMouseDown = function (event) {
                                updateButtons(event.buttons);
                                box.classList.add("button-".concat(event.which));
                                box.classList.remove('p-mouse-pointer-hide');
                            };
                            var onMouseUp = function (event) {
                                updateButtons(event.buttons);
                                box.classList.remove("button-".concat(event.which));
                                box.classList.remove('p-mouse-pointer-hide');
                            };
                            ...
                            function updateButtons(buttons) {
                                for (var i = 0; i < 5; i++) {
                                    box.classList.toggle("button-".concat(i), Boolean(buttons & (1 << i)));
                                }
                            }
                            ...
                            window.removeMouseHelper = function () {
                ...
                case 1:
                    evaluateOnNewDocumentId = (_a.sent()).identifier;
                    /**
                     * Removes the previously injected mouse helper (ghost cursor).
                     */
                    return [2 /*return*/, { removeMouseHelper: removeMouseHelper }];
            }
        });
    });
}
